...
apt-get -y install oracle-java8-set-defaultapt -

# Install PHPStorm
wget http://download.jetbrains.com/webide/PhpStorm-8.0.4.tar.gz
tar -xvf 'PhpStorm-8.0.4.tar.gz'
rm -f 'PhpStorm-8.0.4.tar.gz'
cp /vagrant/resources/jetbrains-phpstorm.desktop /usr/share/applications